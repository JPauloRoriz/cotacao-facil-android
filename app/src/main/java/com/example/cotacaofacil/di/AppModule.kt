...
import com.example.cotacaofacil.domain.usecase.product.GetAllProductsUseCaseImpl
...
val appModule = module {
    ...
    viewModel { StockBuyerViewModel(get(), get(), get()) }
    viewModel { HomeBuyerViewModel(get(), get(), get()) }
